      ...
      <form className="form">
        ...
        <label>
          <input
            ...
            onChange={(e) => setHobbies((p) => ({ ...p, music: e.target.checked }))}
          />
          <span>Music</span>
        </label>
        <label>
          <input
            ...
            onChange={(e) => setHobbies((p) => ({ ...p, movies: e.target.checked }))}
          />
          <span>Movies</span>
        </label>
        <label>
        ...
        <h5>Role</h5>
        <select className="selection_box" value={role} onChange={(e) => setRole(e.target.value)}>
